...
try:
    ...
    sensor_lidar_spawn_point = carla.Transform(carla.Location(x=0, y=0, z=2)
    ...
    visualise_lidar_using_mayavi = mlab.points3d(10, 10, 10, 10, mode='point', figure=lidar_figure)
